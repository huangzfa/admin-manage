...
public static void main(String[] args) {
	String tmp = "[{\"url\":\"http://www.666pano.com/pano/xu_xu_si_jia_hua_yuan/foodImgs/1.jpg\"},{\"url\":\"http://www.666pano.com/pano/xu_xu_si_jia_hua_yuan/foodImgs/2.jpg\"}]";
	String escapeStr=escape(tmp);
	System.out.println("编码：   " + escapeStr);
	System.out.println("%5B%7B%22url%22%3A%22http%3A//www.666pano.com/pano/xu_xu_si_jia_hua_yuan/foodImgs/1.jpg%22%7D%2C%7B%22url%22%3A%22http%3A//www.666pano.com/pano/xu_xu_si_jia_hua_yuan/foodImgs/2.jpg%22%7D%5D".equals(escapeStr));
	String unescapeStr=unescape(escapeStr);
	System.out.println("解码：   " + unescapeStr);
	System.out.println(unescapeStr.equals(tmp));
}
}
