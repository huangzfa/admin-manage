...
public class Base64 {
	...
	/**
	 * A {@link java.io.InputStream} will read data from another
	...
	public static class InputStream extends java.io.FilterInputStream {
		...
		/**
		 * Constructs a {@link java.io.InputStream} in either ENCODE or DECODE
		 * mode.
		 * 
		 * @param in
		 *            the {@link java.io.InputStream} from which to read data.
	...
	/**
	 * A {@link java.io.OutputStream} will write data to another
	...
	public static class OutputStream extends java.io.FilterOutputStream {
		...
		/**
		 * Constructs a {@link java.io.OutputStream} in either ENCODE or DECODE
		 * mode.
		 * 
		 * @param out
		 *            the {@link java.io.OutputStream} to which data will be
