...
$(function(){
	...
	function getData(pageNum, pageSize){
		...
		hjnUtils.ajax({  
	        type:'post',      
	        url:'${ctxA}/operation/activity/listData',  
...
function nameformater(value,row,index){
	var opStr='<a class="si-title-a" href="${ctxA}/operation/activity/form?activityId='+row.activityId+'">'+value+'</a>';
	return opStr;
}
...
function optionformater(value,row,index){
	...
	opStr+='<a class="si-option-a" href="${ctxA}/operation/activity/form?activityId='+row.activityId+'">修改</a>';
	opStr+='<a class="si-option-a" href="${ctxA}/operation/activity/delete?activityId='+row.activityId+'" onclick="return confirmx(\'确定要删除该活动吗？\', this.href)">删除</a>';
	</shiro:hasPermission>
	return opStr;
}
...
<body>
	<ul class="nav nav-tabs" style="margin-bottom:3px;">
		...
		<shiro:hasPermission name="operation:activity:edit">
		<li><a href="${ctxA}/operation/activity/form">添加活动</a></li>
		</shiro:hasPermission>
	</ul>
...
<div class="si-warp" style="top:95px;">
	...
	<table id="tt" class="easyui-datagrid"
		data-options="idField:'activityId',singleSelect:true,striped:true,fit:true,fitColumns:true,pagination:true">
		<thead>
			<tr>
