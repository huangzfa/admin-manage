...
<head>
    ...
    <script type="text/javascript">
        ...
        function getData(){
            ...
            hjnUtils.ajax({
                type:'post',
                url:'${ctxA}/message/push/getPushConfig',
                data:data,
                dataType:'json',
        ...
        function optionformater(value,row,index){
            ...
            opStr+='<a class="si-option-a" href="${ctxA}/message/push/form?id='+row.id+'">查看</a>';
            var state = 0;
        ...
        function editState(id,state){
            ...
            top.$.jBox.confirm(msg,'系统提示',function(v,h,f){
                if(v=='ok'){
                    jQuery.post("${ctxA}/message/push/editState", {'id':id,'state':state},
                        function(data) {
                            if (data.code ==1) {
...
<ul class="nav nav-tabs" style="margin-bottom: 5px;">
    ...
    <shiro:hasPermission name="message:push:edit">
        <li><a href="${ctxA}/message/push/form">新增</a></li>
    </shiro:hasPermission>
</ul>
<div class="si-warp">
    <table id="tt" class="easyui-datagrid"
        ...
        <thead>
        <tr>
            <th data-options="field:'id',width:180,align:'center',halign:'center',fixed:true">渠道编号</th>
            <th data-options="field:'appKey',width:180,align:'center',halign:'center',fixed:true">应用key</th>
