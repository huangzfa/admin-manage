...
public class ImageUtils {
	...
	public static void main(String[] args) {
		// 1-缩放图像：
		// 方法一：按比例缩放
		ImageUtils.scale("D:/慈善/图片测试结果/334.jpg", "D:/慈善/图片测试结果/abc_scale.jpg", 2, true);// 测试OK
		// 方法二：按高度和宽度缩放
		ImageUtils.scale2("D:/慈善/图片测试结果/334.jpg", "D:/慈善/图片测试结果/abc_scale2.jpg", 500, 300, true);// 测试OK
		// 2-切割图像：
		// 方法一：按指定起点坐标和宽高切割
		ImageUtils.cut("D:/慈善/图片测试结果/334.jpg", "D:/慈善/图片测试结果/abc_cut.jpg", 0, 0, 400, 400);// 测试OK
		// 方法二：指定切片的行数和列数
		ImageUtils.cut2("D:/慈善/图片测试结果/334.jpg", "D:/慈善/图片测试结果/", 2, 2);// 测试OK
		// 方法三：指定切片的宽度和高度
		ImageUtils.cut3("D:/慈善/图片测试结果/334.jpg", "D:/慈善/图片测试结果/", 300, 300);// 测试OK
		// 3-图像类型转换：
		ImageUtils.convert("D:/慈善/图片测试结果/334.jpg", "GIF", "D:/慈善/图片测试结果/abc_convert.gif");// 测试OK
		// 4-彩色转黑白：
		ImageUtils.gray("D:/慈善/图片测试结果/334.jpg", "D:/慈善/图片测试结果/abc_gray.jpg");// 测试OK
		// 5-给图片添加文字水印：
		// 方法一：
		ImageUtils.pressText("我是水印文字", "D:/慈善/图片测试结果/334.jpg", "D:/慈善/图片测试结果/abc_pressText.jpg", "宋体", Font.BOLD,
				Color.white, 80, 0, 0, 0.5f);// 测试OK
		// 方法二：
		ImageUtils.pressText2("我也是水印文字", "D:/慈善/图片测试结果/334.jpg", "D:/慈善/图片测试结果/abc_pressText2.jpg", "黑体", 36,
				Color.white, 80, 0, 0, 0.5f);// 测试OK
		// 6-给图片添加图片水印：
		ImageUtils.pressImage("D:/慈善/图片测试结果/水印.png", "D:/慈善/图片测试结果/334.jpg", "D:/慈善/图片测试结果/abc_pressImage.jpg", 0, 0,
				0.5f);// 测试OK
	}
	 ...
	 *            目标切片高度
	 */
	public final static void cut(InputStream srcInputStream, File savePathFile, int x, int y, int width, int height) {
		try {
			// 读取源图像
			BufferedImage bi = ImageIO.read(srcInputStream);
			...
			if (srcWidth > 0 && srcHeight > 0) {
				...
				g.dispose();
				// 输出为文件
				ImageIO.write(tag, "JPEG", savePathFile);
			}
		} catch (Exception e) {
			e.printStackTrace();
		}
