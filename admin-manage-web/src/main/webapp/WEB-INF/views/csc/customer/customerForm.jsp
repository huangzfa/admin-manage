  ...
  <%--  <form:form id="inputForm" modelAttribute="repay" action="${ctxA}/ac/apppage/save" method="post" class="form-horizontal">
    ...
    <div class="control-group">
        <div class="user_info" style="margin-top:1%;">
            <h4>基础信息</h4>
            <a href="#" style="margin-left: 94%" onclick="getLoginLog()">登录记录</a>
            <div class="div_back_color">
                <table class="user_info">
                    <tr>
                        <td style="text-align: left"class="">用户账号:${customer.userName}</td>
                        <td style="text-align: left;"class="">用户ID:${customer.id}</td>
                        <td style="text-align: left;"class="">用户姓名:${customer.realName}<%--<span id="userName"></span> <a href="#">修改</a>--%></td>
                        <td style="text-align: left;"class="">注册时间:<fmt:formatDate value="${customer.addTime}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
                    </tr>
                    <tr>
                        <td style="text-align: left"class="">注册渠道:${customer.channelName}</td>
                        <td style="text-align: left;"class="">最近登录时间:<fmt:formatDate value="${customer.lastLoginTime}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
                    </tr>
                    <tr><td></Td></tr>
                </table>
                </div>
    ...
    <div class="borrow_info" style="margin-top:3%">
        ...
        <div class="div_back_color">
            ...
            <table class="borrow_info" style="width:98%;margin-left: 1%">
                <thead>
                <th style="text-align: center;"class="list_th">订单id</th>
                <th style="text-align: center;"class="list_th">借款流水号</th>
                <th style="text-align: center;"class="list_th">产品名称</th>
                <th style="text-align: center;"class="list_th">姓名</th>
                <th style="text-align: center;"class="list_th">用户账号</th>
                <th style="text-align: center;"class="list_th">借款本金</th>
                <th style="text-align: center;"class="list_th">利息金额</th>
                <th style="text-align: center;"class="list_th">借款周期</th>
                <th style="text-align: center;"class="list_th">借款券</th>
                <th style="text-align: center;"class="list_th">实际到账金额</th>
                <th style="text-align: center;"class="list_th">风控状态</th>
                <th style="text-align: center;"class="list_th">人审状态</th>
                <th style="text-align: center;"class="list_th">放款状态</th>
                <th style="text-align: center;"class="list_th">申请时间</th>
                <th style="text-align: center;"class="list_th">操作</th>
                </thead>
                <tbody id="borrowInfoTable">
                <c:forEach items="${customer.stageBorrowVoList}" var="borrowInfo">
                    <tr borrowId ='${borrowInfo.id}'>
                        <td>${borrowInfo.id}</td>
                        <td>${borrowInfo.borrowNo}</td>
                        <td>${borrowInfo.productName}</td>
                        <td>${customer.realName}</td>
                        <td>${customer.userName}</td>
                        <td>${borrowInfo.amount}</td>
                        <td>${borrowInfo.rateAmount}</td>
                        <td>${borrowInfo.nperName}</td>
                        <td>${borrowInfo.couponAmount}</td>
                        <td>${borrowInfo.arrivalAmount}</td>
                        <td>${borrowInfo.reviewStateName}</td>
                        <td>${borrowInfo.reviewBorrowName}</td>
                        <td>${borrowInfo.borrowStateName}</td>
                        <td><fmt:formatDate value="${borrowInfo.addTime}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
                        <td><a class="si-option-a" href="${ctxA}/bpo/stageBorrow/form?returnUrlType=${customer.id}&id=${borrowInfo.id}">查看</a>
        ...
        <div class="auth_info" style="margin-top:3%">
            ...
            <div class="div_back_color">
                ...
                <table class="user_auth_info" style="width:98%;margin-left: 1%">
                    <span style="margin-left: 1%">用户认证情况</span>
                    <thead>
                    ...
                    <tbody id="userAuth">
                    <c:forEach items="${customer.userAuth}" var="userAuthInfo">
            ...
            <div class="div_back_color">
                <br>
                <table class="user_auth_info" style="width:98%;margin-left: 1%">
                    <span style="margin-left: 1%">已提交认证的金融产品</span>
                    <thead>
                    <th style="text-align: center;"class="list_th">产品名称</th>
                    <th style="text-align: center;"class="list_th">提交时间</th>
                    <th style="text-align: center;"class="list_th">风控额度状态</th>
                    <th style="text-align: center;"class="list_th">最高额度</th>
                    <th style="text-align: center;"class="list_th">操作</th>
                    </thead>
                    <tbody>
                    <c:forEach items="${customer.userProductQuotaList}" var="userProductQuotaInfo">
                        <tr userProductQuotaId ='${userProductQuotaInfo.id}'>
                            <td>${userProductQuotaInfo.productName}</td>
                            <td><fmt:formatDate value="${userProductQuotaInfo.addTime}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
                            <td>${cfg:getDictLabel('riskQuotaState',userProductQuotaInfo.riskQuotaState)}</td>
                            <td>${userProductQuotaInfo.auAmount}</td>
                            <td><a href="#" onclick="getProductAuthConfig(${userProductQuotaInfo.productId})">查看认证项</a></td>
                        </tr>
                    </c:forEach>
                    </tbody>
                </table>
            ...
            <div id="productAuthConfig" class="easyui-dialog" title="产品认证项" data-options="closed:true,modal:true" style="width:60%;padding:10px"  >
                <table class="user_auth_info" style="width:96%;margin-left: 2%">
                    <span style="margin-left: 1%">基础认证项</span>
                    <thead>
                    <th style="text-align: center;"class="list_th">认证名称</th>
                    <th style="text-align: center;"class="list_th">是否可用</th>
                    <th style="text-align: center;"class="list_th">是否必填</th>
                    <th style="text-align: center;"class="list_th">认证顺序</th>
                    </thead>
                    <tbody id = "productAuthConfigTable1">
                    </tbody>

                </table>
                <table class="user_auth_info" style="width:96%;margin-left: 2%">
                    <span style="margin-left: 1%">补充认证</span>
                    <thead>
                    <th style="text-align: center;"class="list_th">认证名称</th>
                    <th style="text-align: center;"class="list_th">是否可用</th>
                    <th style="text-align: center;"class="list_th">是否必填</th>
                    ...
                    <tbody id = "productAuthConfigTable2">
                    </tbody>
        ...
        <div class="borrow_info" style="margin-top:3%">
            ...
            <div class="div_back_color">
                ...
                <div style="text-align: center" class="query_group">
                    <table style="margin-left: 47%">
                        <tr>
                            <c:forEach items="${customer.userCouponStateList}" var="couponStateQuery">
                ...
                <table class="user_coupon_info" style="width:98%;margin-left: 1%">
                    ...
                    <c:forEach items="${customer.userCouponList}" var="userCouponInfo">
...
<script>
    $(function () {
        $("#login").dialog("close")
        $("#productAuthConfig").dialog("close")
    })
    ...
    function getLoginLog() {
        ...
        $.ajax({
            type: "POST",
            url: '${ctxA}/csc/customer/loginList',
            ...
            success: function(data){
                ...
                for (var i = 0 ;i<data.length;i++){
                    var tr = "<tr>";
                    tr += "<td>" + formatDateTime(data[i].loginTime) +"</td>";
                    tr +="<td>" +data[i].edition+"</td>"
                    tr +="<td>" +data[i].sys+"</td>"
                    tr += "<td>" + data[i].phoneModel+"</td>"
                    tr += "<td>" +data[i].ip+"</td>"
                    tr += "</tr>"
    ...
    function setMainBank(id){
        top.$.jBox.confirm("确认设置此卡为用户主卡？",'主卡设置',function(v,h,f){
            ...
            $.ajax({
                type: "POST",
                url: '${ctxA}/csc/customer/setMainBank',
                contentType: "application/x-www-form-urlencoded;charset=utf-8",
    ...
    function resetAuthState(authCode) {
            top.$.jBox.confirm("确认重置用户认证状态？",'系统提示',function(v,h,f){
                ...
                $.ajax({
                    type: "POST",
                    url: '${ctxA}/csc/customer/resetAuthState',
                    contentType: "application/x-www-form-urlencoded;charset=utf-8",
    ...
    $(".stageBorrowQuery").click(function(){
        ...
        $.ajax({
            type: "POST",
            url: '${ctxA}/csc/customer/stageBorrowListQuery',
            contentType: "application/x-www-form-urlencoded; charset=utf-8",
            ...
            success: function(data){
                ...
                for (var i = 0; i < data.length; i++) {
                    ...
                    tr += "<td><a class='si-option-a' href='${ctxA}/bpo/stageBorrow/form?returnUrlType="+userId+"&id=" + data[i].id + "'>查看</a> "
