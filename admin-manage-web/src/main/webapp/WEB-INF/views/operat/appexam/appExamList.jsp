	...
	<script type="text/javascript">
      ...
      $(function(){
        ...
        function getData(pageNum, pageSize){
          ...
          hjnUtils.ajax({
            type:'post',
            url:'${ctxA}/operat/appexam/appExamList',
            data:'channelName='+$('#channelName').val()+'&versionNumber='+$('#versionNumber').val()+'&appId='+$('#appSelect').val()+'&page='+pageNum+'&pagesize='+pageSize,
            dataType:'json',
