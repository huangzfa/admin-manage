...
public class LogoConfig {
     ...
     */  
     public BufferedImage LogoMatrix(BufferedImage matrixImage) throws IOException{  
          ...
          * 读取Logo图片 
          */  
         BufferedImage logo = ImageIO.read(new File(this.logo));  
         //开始绘制图片  
         ...
         RoundRectangle2D.Float round2 = new RoundRectangle2D.Float(matrixWidth/5*2+2, matrixHeigh/5*2+2, matrixWidth/5-4, matrixHeigh/5-4,0,0);  
