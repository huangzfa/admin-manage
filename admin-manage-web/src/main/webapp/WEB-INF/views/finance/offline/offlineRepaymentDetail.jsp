    ...
    <div class="control-group">
        ...
        <div class="acccount_info" style="margin:0 auto">
            ...
            <table class="bill_table" style="width:96%;margin-left: 2%">
                ...
                <th style="text-align: center;"class="bill_list_th">逾期违约金</th>
                ...
                <th style="text-align: center;"class="bill_list_th">本期剩余应还</th>
                </thead>
                <tbody>
                <c:forEach items="${billRepayments}" var="data">
                    <tr biilId ='${data.id}'>
                        <td>${data.billNper}期</td>
                        <td>${data.orderNo}</td>
                        <td>${data.billCurrentRepayAmount}</td>
                        <td>${data.billAmount}</td>
                        <td>${data.billRepayCapital}</td>
                        <td>${data.billRepayRate}</td>
                        <td>${data.overdueDays}</td>
                        <td>${data.overdueAmount}</td>
                        <td>${data.realRepayAmount}</td>
                        <td>${data.sumRepayOverdueAmount}</td>
                        <td>${data.sumRateAmount}</td>
                        <td>${data.repayCapitalAmount}</td>
