...
<ul class="nav nav-tabs">
  <li><a href="${ctxA}/order/manage/orderList">订单列表</a></li>
  <li class="active">
...
<div class="si-warp">
	...
	<div class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				${orderState}
				<c:if test="${o.orderStateZd==2 || o.orderStateZd==3 || o.orderStateZd==8}">
				【原因：${o.stateCause }】
				</c:if>
			</div>
		</div>
		...
		<div class="control-group">
			<label class="control-label">预订入住日期：</label>
			<div class="controls">
				${o.inDate }
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">预订退房日期：</label>
			<div class="controls">
				${o.outDate }
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<div class="dayInfo">
					<ul>
						<c:forEach items="${dayInfo}" var="d" varStatus="ds">
							<li>
								<span>${d.d }</span>
								<span>¥ ${d.p/100 } * ${o.roomNum }</span>
								<span>¥ ${d.p/100 * o.roomNum}</span>
							</li>
						</c:forEach>
					</ul>
		...
		<div class="control-group">
			<label class="control-label">实际退房日期：</label>
			<div class="controls">
				${o.realOutDate }
			</div>
		</div>
	    ...
	    <div class="form-actions">
			<input id="btnCancel" class="btn" type="button" value="返 回" onclick="window.location.href='${ctxA}/order/manage/orderList'"/>
		</div>
	</div>
</div>
</body>
