...
@Controller
@RequestMapping(value = "${authzPath}/app/firstContact")
public class FirstContactController extends BaseController {
    private final static Logger log = LoggerFactory.getLogger(FirstContactController.class);
    private final static String PERMISSIONPRE = "app:firstContact:";
    private final static String ADDRESSPRE = "app/firstContact/";
    private final static String DESC = "紧急联系人";
    ...
    public String list(Integer appId , Model model){
        ...
        return ADDRESSPRE + "firstContactForm";
    }

    @RequiresPermissions(PERMISSIONPRE+"view")
    @RequestMapping(value = "firstContactList")
    @ResponseBody
    public String switchList(FunctionSwitchCriteria functionSwitchCriteria){
        ...
        if (functionSwitchCriteria.getAppId() == null){
            ...
            try {
                ...
                log.error("用户{}，应用id:{}，紧急联系人查询失败",credential,functionSwitchCriteria.getAppId());
                return failJsonResult(e.getMessage());
            }

        }
        //给与查询code 紧急联系人
        functionSwitchCriteria.setFunctionCode(FunctionSwitchEnum.EMERGENCY_CONTACT.getCode());
