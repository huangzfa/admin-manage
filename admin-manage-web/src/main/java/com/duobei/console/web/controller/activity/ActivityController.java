...
public class ActivityController extends BaseController {
    ...
    public void form(Model model, String code) {
        ...
        if(StringUtil.isNotEmpty(code)){
            ...
            if( activity != null ){
                ...
                //兑换模板
                    ...
                    model.addAttribute("przieRelLists",JSON.toJSONString(przieRelList));
                    //红包活动有额外奖励
        ...
        model.addAttribute("prizeLists",prize_list1.addAll(prize_list2));

        model.addAttribute("types",activityTypeService.getAll());
    }
