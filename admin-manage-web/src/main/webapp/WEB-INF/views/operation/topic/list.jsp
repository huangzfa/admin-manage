...
$(function(){
	...
	function getData(pageNum, pageSize){
		...
		hjnUtils.ajax({  
	        type:'post',      
	        url:'${ctxA}/operation/topic/listData',  
...
function nameformater(value,row,index){
	var opStr='<a class="si-title-a" href="${ctxA}/operation/topic/form?topicId='+row.topicId+'">'+value+'</a>';
	return opStr;
}
...
function optionformater(value,row,index){
	...
	opStr+='<a class="si-option-a" href="${ctxA}/operation/topic/form?topicId='+row.topicId+'">修改</a>';
	opStr+='<a class="si-option-a" href="${ctxA}/operation/topic/delete?topicId='+row.topicId+'" onclick="return confirmx(\'确定要删除该专题吗？\', this.href)">删除</a>';
	</shiro:hasPermission>
	return opStr;
}
...
<body>
	<ul class="nav nav-tabs" style="margin-bottom:3px;">
		<li class="active"><a href="javascript:void(0);">专题列表</a></li>
		<shiro:hasPermission name="operation:topic:edit">
		<li><a href="${ctxA}/operation/topic/form">添加专题</a></li>
		</shiro:hasPermission>
	</ul>
...
<div class="si-warp" style="top:95px;">
	...
	<table id="tt" class="easyui-datagrid"
		data-options="idField:'topicId',singleSelect:true,striped:true,fit:true,fitColumns:true,pagination:true">
		<thead>
			<tr>
