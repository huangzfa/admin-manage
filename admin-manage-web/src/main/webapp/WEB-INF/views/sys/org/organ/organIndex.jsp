	...
	hjnUtils.ajax({  
        ...
        success:function(data){  
        	if(data.code==1){
	        	...
	        	treeObj=$.fn.zTree.init($("#ztree"), {
	        		...
	        		callback: {
	        			onClick: function(event, treeId, treeNode) {
	        				$("#organList").attr("src","${ctxA}/sys/organ/list?selectOrganId="+treeNode.organId);
	        			    //alert(treeNode.tId+","+treeNode.organId + ", " + treeNode.organName+", "+treeNode.parentOrganId);
	        			}
	        		}
	        	},data.list);
	        	...
	        	$("#organList").attr("src","${ctxA}/sys/organ/list?selectOrganId="+rootNode.organId);
        	}else{
...
<div id="lrLayout" class="si-layout-box">
	...
	<div class="si-layout-right">
		<iframe id="organList" src="" width="100%" height="100%" frameborder="no" border="0" scrolling="auto" style="display: block;margin: 0;"></iframe>
	</div>
</div>
</body>
</html>