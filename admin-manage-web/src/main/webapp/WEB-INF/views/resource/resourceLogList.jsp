...
<div class="breadcrumb form-search" style="margin-bottom:0;">
    <ul class="ul-form _clearfix">
        <li>
            <label>资源类型：</label>
            <input id="type" placeholder="请输入资源类型" class="input-large" type="text" value="" maxlength="50" />
        </li>
        <li class="btns">
...
<div class="si-warp"  style="top:95px;">
    <table id="tt" class="easyui-datagrid"
        ...
        <tr>
            ...
            <th data-options="field:'addOperatorName',width:80,align:'left',halign:'center',fixed:true">操作人</th>
