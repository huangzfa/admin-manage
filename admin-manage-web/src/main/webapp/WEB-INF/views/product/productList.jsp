...
<div class="si-warp" style="top:95px;">
	<table id="tt" class="easyui-datagrid"
		...
		<thead>
		<tr>
			<th data-options="field:'productName',width:100,align:'center',halign:'center',fixed:true">产品名称</th>
			<th data-options="field:'description',width:120,align:'center',halign:'center',fixed:true">产品描述</th>
			<th data-options="field:'lowQuota',width:100,align:'center',halign:'center',fixed:true">最低借款额</th>
			<th data-options="field:'showMaxQuota',width:100,align:'center',halign:'center',fixed:true">最高借款额</th>
			...
			<th data-options="field:'productState',width:160,align:'center',halign:'center',fixed:true,formatter:stateformater">是否可用</th>
