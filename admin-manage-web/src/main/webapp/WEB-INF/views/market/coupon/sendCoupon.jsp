...
<div class="si-warp">
    ...
    <form:form    method="post" class="form-horizontal">
        <div class="control-group">
            <label class="control-label">卷来源：</label>
            <div class="controls">
                <select  id="couponSource" class="selectpicker show-tick form-control" >
...
<script>
    ...
    function save(){
        ...
        if($("#userSource").val()=='phone' ){
            var tx = "phone="+$("#phone").val()+"&couponSource="+$("#couponSource").val()+"&couponId="+$("#couponId").val()
    ...
    function uploadExcel(){
        ...
        $.ajaxFileUpload({
            url: "${ctxA}/market/coupon/import?couponSource="+$("#couponSource").val()+"&couponId="+$("#couponId").val(),
            secureuri: false,
